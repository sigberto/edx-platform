...
COURSES_WITH_UNSAFE_CODE = ENV_TOKENS.get('COURSES_WITH_UNSAFE_CODE', COURSES_WITH_UNSAFE_CODE)
...
PASSWORD_MIN_LENGTH = ENV_TOKENS.get('PASSWORD_MIN_LENGTH', PASSWORD_MIN_LENGTH)
PASSWORD_MAX_LENGTH = ENV_TOKENS.get('PASSWORD_MAX_LENGTH', PASSWORD_MAX_LENGTH)
PASSWORD_COMPLEXITY = ENV_TOKENS.get('PASSWORD_COMPLEXITY', PASSWORD_COMPLEXITY)
PASSWORD_DICTIONARY_EDIT_DISTANCE_THRESHOLD = ENV_TOKENS.get(
    'PASSWORD_DICTIONARY_EDIT_DISTANCE_THRESHOLD',
    PASSWORD_DICTIONARY_EDIT_DISTANCE_THRESHOLD
)
PASSWORD_DICTIONARY = ENV_TOKENS.get('PASSWORD_DICTIONARY', PASSWORD_DICTIONARY)
